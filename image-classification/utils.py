...
def init_distributed_mode(args):
    ...
    torch.distributed.barrier(device_ids=[args.gpu])  # NOTE: Original is `torch.distributed.barrier()`
...
def reduce_across_processes(val):
    ...
    dist.barrier(device_ids=[torch.cuda.current_device()])  # NOTE: Original is `dist.barrier()`
    dist.all_reduce(t)
    return t
